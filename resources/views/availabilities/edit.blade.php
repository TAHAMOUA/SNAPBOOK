<x-app-layout>
    <div class="book-wrap">
        ...
        <div class="admin-top">
            <div class="admin-title">Edit Availability Slot</div>
        </div>

        <div class="apanel">
            <div class="p-6">
                <form method="POST" action="{{ route('availabilities.update', $availability->id_availability) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="fld">
                        ...
                        <x-text-input
                            ...
                            type="date"
                            name="available_date"
                            :value="old('available_date', $availability->available_date->format('Y-m-d'))"
                            required
                            autofocus
                        />
